# R tutorial for Statistical Methods in Ecology and Evolution-  ZOL851
...
# to quit R
q()  ##NOTE to MAC (OS X) users... this will no longer work (R V2.11.+ ) from the Mac R GUI... See below in OS X specific notes..
...
a.function <- function(input variable 1, input variable 2, argument, etc...) {expressions to calculate}
...
# similarly 
length(string.1) # this gives an output of 1
nchar(string.1)  # this gives the 11 characters
#################################
