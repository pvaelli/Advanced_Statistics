...
# however it is faster to use the index.
...
while(i <= 10){
	print(i)
	i <- i + 0.5}
# This shows that it does not need to do it as integers
...
# Traditional way of outputting random numbers in many older programming languages
